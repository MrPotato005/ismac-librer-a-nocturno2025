...
public class FacturaControllerTestUnitaria {
    ...
    public void setUp() {
        ...
        factura.setIva(12.01);
        factura.setTotal(112.2);
    ...
    public void testFindOneExistente() {
        ...
        assertEquals(200, respuesta.getStatusCodeValue());
        assertEquals(factura.getNumFactura()factura(), respuesta.getBody().getNumFactura());
    ...
    public void testSave() {
        ...
        assertEquals(200, respuesta.getStatusCodeValue());
        assertEquals("F001-0001", respuesta.getBody().getNumFactura()factura());
    }
